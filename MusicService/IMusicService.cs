...
namespace MeNext.MusicService
{
	...
	public interface IMusicService
	{
		...
		/// <summary>
		/// Adds a listener for when things change in the now playing status
		/// </summary>
		/// <param name="listener">Listener.</param>
		void AddPlayStatusListener(ISongPlayListener listener);

		/// <summary>
		/// Removes a listener for when things change in the now playing status
		/// </summary>
		/// <param name="listener">Listener.</param>
		void RemovePlayStatusListener(ISongPlayListener listener);
