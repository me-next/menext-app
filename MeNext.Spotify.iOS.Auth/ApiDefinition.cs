...
using UIKit;
using Foundation;    // This using is necessary. They're lying.
using ObjCRuntime;
using StoreKit;
...
namespace MeNext.Spotify.iOS.Auth
{
    ...
    public interface SPTAuthViewDelegate
    {
        ...
        void AuthenticationViewControllerDidLoginWithSession(SPTAuthViewController authenticationViewController, SPTSession session);
        ...
        void AuthenticationViewControllerDidFailToLogin(SPTAuthViewController authenticationViewController, NSError error);
